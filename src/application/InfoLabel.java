...
public class InfoLabel extends Label {
	...
	public final static String BACKGROUND_IMAGE = "/resources/yellow_small_panel.png";
	...
	public InfoLabel(String text) {
		...
		BackgroundImage backgroundImg = new BackgroundImage(new Image(BACKGROUND_IMAGE, 380, 49, 
